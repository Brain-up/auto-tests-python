...
class TestFooter:
    ...
    class TestFooterImages:
        ...
        def test_fp_04_02_verify_visible_sizes_of_arasaac_link_image(self, driver, main_page_open):
            ...
            print(f"The current visible sizes of the picture in the {link_href} link is: {image_width}x{image_height} px")
            assert image_width != 0, f"The image in the ARASAAC link in Footer is invisible, a reason: image width = 0"
            assert image_height != 0, "The image in the ARASAAC link in Footer is invisible, a reason: image height = 0"
